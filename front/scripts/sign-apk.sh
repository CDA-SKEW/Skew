...
keytool -genkey -v -keystore app-release-unsigned.keystore -alias $name -keyalg RSA -keysize 2048 -validity 20000
...
# jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore $name.keystore ./$name-unsigned.apk $name
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore app-release-unsigned.keystore ./app-release-unsigned.apk $name
